...
for(s in 1:2){
  ...
  Model = 1 # Schaefer model for all runs  
  ...
  catch = read.csv(paste0(File,"/",assessment,"/catch",assessment,".csv"))[,c(1,2+1)] #select catch series
  ...
  fixed.obsE = c(0.25) # Important if SE.I is not available
  ...
  TACs = seq(20000,70000,5000) #example

...
fontsize: 11pt
---
The code below can be used to reproduce analysis and figures from Winker et al (2018, in review), when used in conjuntion with `JABBAv1.1.R` and data from the South Atlantic Swordfish Fishery `SWO_SA`.
